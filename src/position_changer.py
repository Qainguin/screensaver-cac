...
class PositionChanger(QDialog):
    def __init__(self, parent):
        ...
        self.topLeftButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(0))
        ...
        self.topButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(1))
        ...
        self.topRightButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(2))
        ...
        self.centerLeftButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(3))
        ...
        self.centerButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(4))
        ...
        self.centerRightButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(5))
        ...
        self.bottomLeftButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(6))
        ...
        self.bottomButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(7))
        ...
        self.bottomRightButton.pressed.connect(lambda: parent.label_position_handler.change_label_position(8))
